...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("vertexShader", "fragmentShader");
    Shader lightCubeShader("lightCubeVS", "fragmentShader");
    ...
    // -----------------------------------------------------------------------------
    unsigned int diffuseMap = loadTexture("1.jpg");
    unsigned int specularMap = loadTexture("1.jpg");
